...
1. Make an [Issue](https://github.com/paps/unity-toolbar-extender-ui-toolkit/issues/new)
...
```json
    {
        "dependencies": {
            "com.paps.unity-toolbar-extender-ui-toolkit": "https://github.com/YOUR_USER/unity-toolbar-extender-ui-toolkit.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at santiagoperez.-@hotmail.com.
